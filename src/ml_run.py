...
if __name__ == "__main__":
    ...
    # Prepare the data
    feature_cols = ['SP', 'SalesAcc', 'SolvencyRatio', 'StdErr180D', 'WCTurn']  # Example features
    target_col = 'your_target_column'  # Replace with your target column
    
    ml.prepare_data(feature_cols, target_col)
    
    # Train and evaluate models
    scores = ml.train_models()
